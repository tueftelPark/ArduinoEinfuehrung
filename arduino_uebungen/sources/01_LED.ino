...
void setup()
{ 
//TODO: Definiere den PIN, an dem die LED angeschlossen ist, als Ausgang. Ersetze PIN mit der Zahl für die LED und entscheide: OUTPUT oder INPUT?
//EXPECT: ^\d+$
//EXPECT: ^(OUTPUT|INPUT)$
